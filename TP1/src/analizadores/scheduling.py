# analizadores/scheduling.py - Analizador que extrae info de scheduling de cada proceso
...
def correr_scheduling(pids_compartidos, snapshot, intervalo, evento_apagado):
